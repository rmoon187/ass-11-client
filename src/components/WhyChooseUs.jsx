                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            color: "from-teal-500 to-green-600 dark:from-teal-600 dark:to-green-700"
                        },
                        {
                            icon: (
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        >
                            ...
                            <div className="relative h-full bg-white dark:bg-gray-900 rounded-xl p-8 shadow-lg border border-gray-100 dark:border-gray-600/30 overflow-hidden">
                                <div className="flex flex-col items-center text-center">
                                    <div className={`p-4 mb-6 rounded-xl bg-gradient-to-r ${feature.color} text-white shadow-md`}>
                                        {feature.icon}
                                    </div>
                                    <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-green-600 dark:from-blue-400 dark:to-green-400 mb-3">
                                        {feature.title}
                                    </h3>
